...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, 110, 50));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 150, 50));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 20, 300, 50));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 20, 190, 50));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 20, 260, 50));
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 20, 100, 50));

        btnCategory.setBackground(new java.awt.Color(60, 60, 60));
        btnCategory.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        btnCategory.setForeground(new java.awt.Color(102, 255, 255));
        ...
        getContentPane().add(btnCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 680, 200, 50));

        btnNewProduct.setBackground(new java.awt.Color(60, 60, 60));
        btnNewProduct.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        btnNewProduct.setForeground(new java.awt.Color(102, 255, 255));
        ...
        btnNewProduct.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        btnNewProduct.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnNewProductActionPerformed(evt);
            }
        });
        getContentPane().add(btnNewProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 680, 180, 50));

        btnViewEditDeleteProduct.setBackground(new java.awt.Color(60, 60, 60));
        btnViewEditDeleteProduct.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        btnViewEditDeleteProduct.setForeground(new java.awt.Color(102, 255, 255));
        ...
        btnViewEditDeleteProduct.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        btnViewEditDeleteProduct.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnViewEditDeleteProductActionPerformed(evt);
            }
        });
        getContentPane().add(btnViewEditDeleteProduct, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 680, 280, 50));

        btnVerifyUsers.setBackground(new java.awt.Color(60, 60, 60));
        btnVerifyUsers.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        btnVerifyUsers.setForeground(new java.awt.Color(102, 255, 255));
        ...
        btnVerifyUsers.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        btnVerifyUsers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVerifyUsersActionPerformed(evt);
            }
        });
        getContentPane().add(btnVerifyUsers, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 680, 180, 50));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Homepage.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1550, 830));
